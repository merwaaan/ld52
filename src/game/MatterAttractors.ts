...
export const MatterAttractors = {
  ...
  install: function (base) {
    ...
    base.before("Engine.update", function (engine: Matter.Engine) {
  ...
  Body: {
     ...
     */
    init: function (body: Matter.Body) {
  ...
  Engine: {
     ...
     * @returns {void} No return value.
     */
    update: function (engine: Matter.Engine) {
  ...
  Attractors: {
     ...
     * @returns {void} No return value.
     */
    gravity: function (bodyA: Matter.Body, bodyB: Matter.Body) {
